...
internal static class AnnouncementParserTests
{
    ...
    private static void ParsesSupportedMarkdownBlocks()
    {
        ...
        AssertEqual("https://github.com/168chenxin/ShuangXiTongQieHuan", blocks[6].ImageUrl, "The project URL should be preserved.");
    }
